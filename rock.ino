...
{
    return getPointValue(element.position.x, element.position.y) == 3 && getPointValue(element.position.x + element.width - 1, element.position.y) == 3 && getPointValue(element.position.x + element.width - 1, element.position.y + element.height - 1) == 3 && getPointValue(element.position.x, element.position.y + element.height - 1) == 3;
}
